        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" id="list-menu">
              ...
              <li><a href="<?php echo e(route('blogs.home')); ?>" target="_blank">Blog</a></li>
    ...
    <div class="row">
         <div class="col-md-3 col-sm-2">
            <div class="foto-profil">
              <img src="<?php echo e(asset('img/test1.jpg')); ?>" alt="" class="img-thumbnail">    
            </div>
         </div> 
...
<script src="<?php echo e(asset('js/analytic.min.js')); ?>"></script>
</body>
</html>